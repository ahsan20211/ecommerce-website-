                        ...
                        <h4 class="text-left">Checkout Form</h4>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="f_name" id="firstName"
                                           placeholder="Enter your first name" required>
                                </div>
                                <div class="col-md-12">
                                    <label for="lastName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" name="l_name" id="lastName"
                                           placeholder="Enter your last name" required>
                                </div>
                                <input type="hidden" name="total_price" placeholder="price" value="{{$total}}">
                            </div>
